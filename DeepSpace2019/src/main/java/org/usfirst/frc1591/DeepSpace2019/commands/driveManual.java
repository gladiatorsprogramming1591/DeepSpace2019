        ...
        if((Robot.oi.driveStick.getMagnitude() > .05) && !slow && (m_rot == 0)){
            ...
            Robot.driveTrain.fieldDrive(strafe, vertical, m_rot, gyroDeg);
                ...
                if(m_currentArray == 0){ //if 0, needs to be manually reset to near bottom of array
                    m_targetArray = 6;
                } else if((m_currentArray % 2 == 0) && (m_currentArray != 0)) { //if even and not 0
                    m_targetArray = m_currentArray - 2;
                } else if(m_currentArray % 2 != 0){ //if odd 
                    m_targetArray = m_currentArray - 1;
                }
                m_rot = -1;
                if(m_targetArray >= 8){
                ...
                if(m_currentArray == 7){ //if 7, needs to be manually reset to near top of array
                    ...
                    m_targetArray = m_currentArray + 1;
                } else if((m_currentArray % 2 != 0) && (m_currentArray !=7)){ //if odd and not 7
                    m_targetArray = m_currentArray + 2;
                }
                m_rot = 1;
                if(m_targetArray >= 8){
                ...
                if((m_currentArray == 6) || (m_currentArray == 7)){ //if 6 or 7, needs to be manually reset to top of array
                    m_targetArray = 0;
                } else if((m_currentArray % 2 == 0) || (m_currentArray == 0) && (m_currentArray != 6) ) { //if even or 0 and not 6 
                    m_targetArray = m_currentArray + 2;
                } else if((m_currentArray % 2 != 0) && (m_currentArray !=7)){ //if odd and not 1
                    m_targetArray = m_currentArray + 1;
                }
                m_rot = 1;
                if(m_targetArray >= 8){
